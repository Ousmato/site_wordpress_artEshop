...
/*
Plugin Name: ArtEshop Contact Form Plugin
...
*/
    ...
    function deliver_mail() {
        ...
        if ( isset( $_POST['cf-submitted'] ) ) {
            ...
            try {
                ...
                $mail->Username   = 'ousmatotoure73@gmail.com';                     //SMTP username
                $mail->Password   = 'knuolandffpnidky';                               //SMTP password
                ...
                //Recipients
                $mail->setFrom('ousmatotoure73@gmail.com','ArtEshop');
                $mail->addAddress($to);     //Add a recipient
        
                $headers = "From: $name <$email>" . "\r\n";

                $mail->addReplyTo($email, $name);
                $mail->Subject = 'Contact ArtEshop';
                $mail->isHTML(false);
                $mail->Body = <<<EOT
                E-mail: $email
                Nom: $name
    ...
    add_shortcode( 'artEshop_contact_form', 'cf_shortcode' );
?>